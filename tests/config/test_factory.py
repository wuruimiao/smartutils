...
def test_conf_factory_create_single():
    ...
    ConfFactory.register(ConfKey("__test__"), meta=ConfMeta(False, True))(
        DummyConf
    )  # 类型强制转换
...
def test_conf_factory_create_missing_required():
    ...
    ConfFactory.register(ConfKey("__test__"), meta=ConfMeta(False, True))(DummyConf)
...
def test_conf_factory_create_missing_not_required():
    ...
    ConfFactory.register(ConfKey("__test2__"), meta=ConfMeta(False, False))(DummyConf2)
...
def test_conf_factory_create_multi():
    ...
    ConfFactory.register(ConfKey("__test3__"), meta=ConfMeta(True, True))(DummyConf3)
...
def test_conf_factory_create_multi_missing_group_default():
    ...
    ConfFactory.register(ConfKey("__test4__"), meta=ConfMeta(True, True))(DummyConf4)
    # with pytest.raises(ConfigError):
